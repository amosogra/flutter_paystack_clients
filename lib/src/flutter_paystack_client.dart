...
class PaystackClient {
  ...
  static var _plugin = PaystackPlugin();//init
  ...
  static Future<CheckoutResponse> checkout(BuildContext context,
      {required Charge charge,
      bool fullscreen = false,
      Widget? logo,
      bool hideEmail = false,
      bool hideAmount = false,
      CheckoutMethod method = CheckoutMethod.selectable}) async {
    ...
    if (kIsWeb) return _web.checkout(charge, _publicKey!, method: method);
